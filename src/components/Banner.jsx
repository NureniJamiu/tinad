  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center px-4">
        <h1 className="text-[#694D29] text-4xl sm:text-5xl lg:text-7xl font-bold pb-2 text-center" style={{ WebkitTextStroke: '2px white', textShadow: '0 0 8px rgba(255, 255, 255, 0.8)' }}>{text}</h1>
